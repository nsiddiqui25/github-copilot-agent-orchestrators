...
ALWAYS use #context7 MCP Server to read relevant documentation for .NET, ASP.NET Core, Entity Framework Core, and any other libraries involved. Do this every time. Never assume that you know the answer as these things change frequently. Your training date is in the past so your knowledge is likely out of date, even if it is a technology you are familiar with.
